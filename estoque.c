...
void inicializarEstoque(Estoque *estoque)
{
	...
	estoque->ingredientes[5] = (Ingrediente){6, "Bacon", 1.0, 10};
	estoque->ingredientes[6] = (Ingrediente){7, "Picles", 1.0, 10};
	estoque->ingredientes[7] = (Ingrediente){8, "Cebola", 3.0, 10};
	estoque->ingredientes[8] = (Ingrediente){9, "Onion Rings", 2.0, 10};
	estoque->ingredientes[9] = (Ingrediente){10, "Maionese do Pato", 1.5, 10};
	estoque->ingredientes[10] = (Ingrediente){11, "Falafel", 2.5, 10};
