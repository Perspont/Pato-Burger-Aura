...
{
	cardapio[0] = (Burger){1, "Bit and Bacon", 16.0, {1, 6, 3, 2, 1, 0, 0, 0}};
	cardapio[1] = (Burger){2, "Duck Cheese", 14.0, {1, 4, 5, 3, 1, 0, 0, 0}};
	cardapio[2] = (Burger){3, "Quackteirão", 19.0, {1, 4, 3, 2, 3, 1, 0, 0}};
	cardapio[3] = (Burger){4, "Big Pato", 27.0, {1, 2, 4, 1, 2, 3, 4, 1}};
	cardapio[4] = (Burger){5, "Zero e Um", 12.0, {1, 3, 2, 1, 0, 0, 0, 0}};
	cardapio[5] = (Burger){6, "Chicken Duckey", 20.0, {1, 12, 8, 13, 11, 1, 0, 0}};
