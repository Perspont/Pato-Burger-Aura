...
void inicializarCardapio(Burger *cardapio)
{
    ...
    // --- COMENTÁRIOS MODIFICADOS ---
	cardapio[0].ingredientes = inicializa_BitAndBacon(); //Passar por referencia exigiria criar 10 pilhas na funcao principal,
	cardapio[1].ingredientes = inicializa_DuckCheese();	 //uma pra cada hamburguer. Acho que fica muito poluido. Por isso, faco a
	cardapio[2].ingredientes = inicializa_Quackteirao(); //funcao retornar a pilha para o index em cardapio do qual pertence o hamburguer.
